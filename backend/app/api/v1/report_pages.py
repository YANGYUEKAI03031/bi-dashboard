...
from app.schemas.report_page import (
    ReportPageCreate, ReportPageUpdate, ReportPageResponse,
    ReportPageDashboardCreate, ReportPageDashboardUpdate, ReportPageDashboardResponse
)
...
async def get_report_page(
    ...
    try:
        ...
        if not page:
            raise HTTPException(status_code=404, detail="报表页不存在")
